...
\nAlso for Pike and Perch the min and max values are spread out a lot more than the rest whereas for Smelt all 3 values are around 
\na close range thus making the mean  of this species much more reliable.
